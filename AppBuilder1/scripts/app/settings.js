...
var appSettings = {
    ...
    everlive: {
        apiKey: 'HPWCHXYrVBRer4rp', // Put your Backend Services API key here
        scheme: 'http'
    },

    eqatec: {
        productKey: 'a969230200014cc5aa4bb08baddeb8b1',  // Put your EQATEC product key here
        version: '1.0.0.0' // Put your application version here
    },
    
    feedback: {
        apiKey: '34d9ff70-d458-11e4-9617-6d85bf2244f6'  // Put your AppFeedback API key here
    },
